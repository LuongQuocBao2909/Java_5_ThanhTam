...
public class QLSanPhamController {
    ...
    public String create(Model model,@ModelAttribute("spDTO") ChiTietSanPhamDTO chiTietSanPhamDTO) {
    ...
    public String store(Model model , @Valid @ModelAttribute("spDTO") ChiTietSanPhamDTO chiTietSanPhamdto, BindingResult result){
        if(result.hasErrors()){
            ...
            chiTietSPService.add(chiTietSanPhamdto);
