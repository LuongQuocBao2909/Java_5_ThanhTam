...
public class DonHangController {
    ...
    public String index(Model model){
        List<HoaDonChiTietDTO> listhdct = hoaDonCTService.getAll();
        model.addAttribute("listhd",listhdct);
    ...
    public String search(Model model, @RequestParam("name") String name,
     ...
     if(name.equals("")) {
         ...
         List<HoaDonChiTietDTO> listhd = hoaDonCTService.searchHoaDonbyStatus(status1);
         model.addAttribute("listhd",listhd);
     }else {
         Integer status1 = Integer.parseInt(status);
         List<HoaDonChiTietDTO> listhd = hoaDonCTService.searchHoaDon(name, status1);
         model.addAttribute("listhd",listhd);
     }
    ...
    public String detail(Model model,@PathVariable("id") Integer id){
        HoaDonChiTietDTO hdct = hoaDonCTService.findById(id);
        model.addAttribute("hd",hdct);
