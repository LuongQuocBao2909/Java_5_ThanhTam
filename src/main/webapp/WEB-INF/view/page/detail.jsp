        ...
        <div class="container">
            <div class="row">
                <div class="col-6" style="border: 1px solid gray;">
                    <img src="${ pageContext.request.contextPath }/${sp.moTa}" alt="" width="100%">
                </div>
                    ...
                    <div class="pick-diamond">
                        <div class="pick-am">
                            ...
                            <div class="pickamct count-cart">
                                <p >Số lượng: <button ng-click ="giam()">-</button><input type="text" value="1" name="soluong" ng-model="soluong" required style="width:30px ;"><button ng-click ="tang()">+</button></p>
                            </div>
                        </div>
                    </div>
                    <hr>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="d-grid gap-2">
                                    <button class="btn btn-danger" type="button" formaction="/donhang/${sp.id}"> <img src="${ pageContext.request.contextPath }/img/ic-ghw.png" alt="">  Mua ngay</button>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="d-grid gap-2">
                                    <button class="btn btn-danger" type="button" formaction="/giohang/${sp.id}"> <img src="${ pageContext.request.contextPath }/img/ic-ghw.png" alt="">  Thêm vào giỏ hàng</button>
                                </div>
                            </div>
                        </div>
                        </form>
