                    ...
                    <ul class="nav justify-content-end">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu" >
                                ...
                                <%--                                    <div  ng-if="user.vaiTro == 0">--%>
                                <%--                                        <li><a class="dropdown-item" href="#admin"> <img src="img/ic-account.png" alt="" /> Admin</a></li>--%>
                                <%--                                        <li><a class="dropdown-item" href="#doimatkhau"> <img src="img/ic-account.png" alt="" /> Đổi mật khẩu</a></li>--%>
                                <%--                                    </div>--%>
                                <%--                                    <div  ng-if="user.vaiTro == 1">--%>
                                <%--                                        <li><a class="dropdown-item" href="#doimatkhau"> <img src="../img/newaccid-red.png" alt="" /> Đổi mật khẩu</a></li>--%>
                                <%--                                    </div>--%>
                                <%--                                    <li><a ng-click="logout()" class="dropdown-item" href=""> <img src="../img/loginaccix.png" alt="" /> Logout</a></li>--%>
                                <%--                                </div>--%>

                            </ul>
                        </div>
                        <article ng-controller="detail">
                            <li class="nav-item">
                                <a class="nav-link"  href="/giohang" > <img src="${ pageContext.request.contextPath }/img/ic-gh.png" alt=""  />  Giỏ hàng </a>
